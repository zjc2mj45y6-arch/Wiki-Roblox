...
const games = [
  makeGame("Brookhaven RP", "Roleplay", "Simulador social para crear historias, vivir en ciudad y jugar con amigos.", { placeId: 4924922222, image: "Imagenes/brookhaven-rp-cover.png", creator: "Wolfpaq", year: 2020, badges: ["Top del dia", "Top del mes"] }),
  makeGame("Adopt Me!", "Simulacion", "Juego de crianza y coleccion de mascotas con sistema de intercambio.", { placeId: 920587237, image: "Imagenes/adopt-me-cover.png", creator: "Uplift Games", year: 2017, badges: ["Top del dia", "Top del mes"] }),
  makeGame("Blox Fruits", "Aventura", "Aventura de exploracion y combate donde mejoras habilidades y equipo.", { placeId: 2753915549, image: "Imagenes/blox-fruits-cover.png", creator: "Gamer Robot Inc", year: 2019, badges: ["Top del dia", "Top del mes"] }),
  makeGame("Tower of Hell", "Obby", "Desafio de parkour por niveles sin puntos de control.", { placeId: 1962086868, image: "Imagenes/tower-of-hell-cover.png", creator: "YXCeptional Studios", year: 2018 }),
  makeGame("Tower Defense Simulator", "Tower Defense", "Tower defense cooperativo donde colocas torres para frenar oleadas de enemigos.", { placeId: 3260590327, image: "Imagenes/tower-defense-simulator-cover.png", creator: "Paradoxum Games", year: 2019, badges: ["Top del mes"] }),
  makeGame("Arsenal", "Shooter", "Shooter competitivo de rondas cortas con armas variadas.", { placeId: 286090429, image: "Imagenes/arsenal-cover-original-style.png", creator: "ROLVe Community", year: 2015 }),
  makeGame("Murder Mystery 2", "Suspenso", "Juego de roles ocultos donde debes descubrir al asesino.", { placeId: 142823291, image: "Imagenes/murder-mystery-2-cover.png", creator: "Nikilis", year: 2014, badges: ["Top del dia", "Top del mes"] }),
  makeGame("Pet Simulator X", "Simulacion", "Colecciona mascotas para desbloquear zonas y mejorar progreso.", { placeId: 6284583030, image: "Imagenes/pet-simulator-x-cover.png", creator: "BIG Games", year: 2021 }),
  makeGame("Doors", "Terror", "Experiencia de terror cooperativa con exploracion y supervivencia.", { placeId: 6516141723, image: "Imagenes/doors-cover.png", creator: "LSPLASH", year: 2022 }),
  makeGame("RIVALS", "Shooter", "Shooter competitivo de duelos rapidos con armas, movilidad y partidas intensas.", { placeId: 17625359962, image: "Imagenes/rivals-cover.png", creator: "Nosniy Games", year: 2024, badges: ["Top del dia", "Top del mes"] }),
  makeGame("Jujutsu Shenanigans", "Aventura", "Combate anime caotico con habilidades vistosas y partidas llenas de energia.", { placeId: 9391468976, image: "Imagenes/jujutsu-shenanigans-cover.png", creator: "Awesome Ninja Games", year: 2024, badges: ["Top del dia", "Top del mes"] }),
  makeGame("99 Nights in the Forest", "Supervivencia", "Supervivencia cooperativa donde gestionas recursos y resistes noches peligrosas.", { placeId: 79546208627805, image: "Imagenes/99-nights-forest-cover.png", creator: "Grandma's Favourite Games", year: 2025, badges: ["Top del dia", "Top del mes"] }),
  makeGame("Fish It!", "Simulacion", "Pesca relajada con progresion rapida, coleccion y una comunidad en fuerte crecimiento.", { placeId: 121864768012064, image: "Imagenes/fish-it-cover.png", creator: "Fish It Devs", year: 2026, badges: ["Top del mes"] }),
  ...
  makeGame("Steal a Brainrot", "Simulacion", "Juego viral de coleccion y robo de brainrots con progresion rapida.", { creator: "Brainrot Games", badges: ["Top global", "Top del mes"] }),
  ...
  makeGame("Forsaken", "Terror", "Horror multijugador con supervivientes, cazadores y objetivos por ronda.", { creator: "Forsaken Dev Team", badges: ["Top del mes"] }),
